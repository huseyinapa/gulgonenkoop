...
export default function Order() {
  ...
  async function cancelOrder(orderId: string) {
    try {
      ...
      const cancelledOrder = await orderManager.cancelOrder(cancelOrderForm as any);
  ...
  function OrderCard({ data, setDetails, cancelOrder }: { data: any, setDetails: (details: any[]) => void, cancelOrder: (orderId: string) => Promise<boolean> }) {
...
function ModalDetails({ details }: { details: any[] }) {
