...
export default function PayHeader({ onClick }) {
  return (
    <div className="navbar justify-center h-40 p-4">
      {/* Büyük Ekran */}
      <div className="navbar-start hidden lg:flex bg-slate-300">
      ...
      <div className="navbar-center hidden lg:flex mx-auto justify-center items-center space-x-6  bg-slate-400"></div>
      ...
      <div className="navbar-end mx-auto justify-end items-center bg-slate-400">
