...
export default function TermsofUse() {
  ...
  return (
    <div data-theme="garden">
      ...
      <p>Son güncellenme: 17 Ekim 2023</p>
      <p>
        Sevgili ziyaretçimiz, lütfen https://www.gonenkleopatra.com/ web
        sitemizi ziyaret etmeden önce işbu kullanım koşulları sözleşmesini
        dikkatlice okuyunuz. Siteye erişiminiz tamamen bu sözleşmeyi kabulünüze
        ve bu sözleşme ile belirlenen şartlara uymanıza bağlıdır. Şayet bu
      ...
      <p>
        https://www.gonenkleopatra.com/ web sitesi Gönen Kleopatra tarafından
        ...
        yapma hakkı, tek taraflı olarak SİTE'ye aittir ve SİTE üzerinden güncel
        olarak paylaşılacak olan bu değişiklikleri, tüm kullanıcılarımız baştan
        kabul etmiş sayılır.
      </p>
      <h2>Gizlilik</h2>
      <p>
        ...
        kullandığınız takdirde, bu verilerin işlenmesinin gizlilik politikasına
        uygun olarak gerçekleştiğini kabul edersiniz.
      </p>
      <h2>Hizmet Kapsamı</h2>
      <p>
        Gönen Kleopatra olarak, sunacağımız hizmetlerin kapsamını ve niteliğini,
      ...
      <p>
        ...
        "içerik" olarak anılacaktır) Gönen Kleopatra olup, tüm hakları saklıdır.
