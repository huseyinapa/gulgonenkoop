...
export default function RegisterModal() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            const userData = await userService.checkUserEmail(userDataForm as unknown as string);
            ...
            if (userData) {
                ...
                formData.append("last_login", date.toString());
                formData.append("date", date.toString());

                const response = await userService.registerUser(formData as unknown as string);
